...
function CardSummary(prosp: CardSummaryProps) {
    const { average, icon: Icon, title, total, tooltipText} = prosp
    return (
    <div className='shadow-sn bg-background rounded-lg p-5 hover:shadow-lg transition'>
